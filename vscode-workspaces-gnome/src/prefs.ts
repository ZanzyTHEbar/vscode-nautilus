...
export default class GnomeRectanglePreferences extends ExtensionPreferences {
    ...
    fillPreferencesWindow(window: Adw.PreferencesWindow) {
        ...
        // Bind settings
        this._settings!.bind('new-window', newWindowSwitch, 'active', Gio.SettingsBindFlags.DEFAULT);
        this._settings!.bind('vscode-location', vscodeLocationEntry, 'text', Gio.SettingsBindFlags.DEFAULT);
        this._settings!.bind('refresh-interval', refreshGroupEntry, 'value', Gio.SettingsBindFlags.DEFAULT);
    }
}